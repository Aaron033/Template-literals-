var petsData = [
    ...
    name: "Purrsloud",
    species: "Cat",
    favFoods: ["Beef food", "sea food", "<strong>any</strong> food","cavage food"],
    birthYear: 2017,
...
//The argument name in foods function does not matter 
function foods(foodss){
    return `
<h4> Favorite Foods </h4> 
<ul class= "foods-list"> 
${foodss.map(food =>`<li> ${food}</li>`
).join('')}
</ul> 
